...
EXEC = editor labyrinthe
OBJETS = ncurses.o outils_editor.o outil.o 
NOM_PROJET = laby
...
outils_editor.o: outils_editor.c outils_editor.h outil.h
outil.o: outil.c outil.h
labyrinthe.o: labyrinthe.c outil.h outils_editor.h
editor.o: editor.c outils_editor.h outil.h ncurses.h
